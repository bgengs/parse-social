...
namespace App\Handlers\Auth\SocialAuth\Two\Providers;

use App\Handlers\Auth\SocialAuth\Two\AbstractProvider;
use App\Handlers\Auth\SocialAuth\Two\ProviderInterface;
use App\Handlers\Auth\SocialAuth\Two\User;
...
class BitbucketProvider extends AbstractProvider implements ProviderInterface
{
	...
	protected function mapUserToObject(array $user)
	{
		return (new User)->setRaw($user)->map([
			...
			'avatar' => $user['links']['avatar']['href'], //FIXME: handle issues, move to dot separated loader
		]);
	}
	/**
